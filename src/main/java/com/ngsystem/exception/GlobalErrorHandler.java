package com.ngsystem.exception;
...
//*spring 2.7
    ...
    public ResponseEntity<CustomErrorResponse> handAllException(ModelNotFoundException ex, WebRequest req){
    ...
    public ResponseEntity<CustomErrorResponse> handAllException(SQLException ex, WebRequest req){
        CustomErrorResponse er=new CustomErrorResponse(LocalDateTime.now(),ex.getMessage(),req.getDescription(false));
